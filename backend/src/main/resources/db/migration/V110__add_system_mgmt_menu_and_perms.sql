...
-- 2. 添加用户管理菜单（如果不存在）
INSERT INTO t_menu (parent_id, menu_name, menu_code, permission, menu_type, path, sort_order, deleted)
SELECT 1, '用户管理', 'system_user', 'system:user:list', 'MENU', '/system/user', 0, 0
