 ...
 * 按 10 级关键词分组 100% 给出 classification, 永不返回 null.
 * <p>
 * 优先级 (1 最高, 10 兜底):
 * <pre>
...
public class FallbackHeuristicService {
    ...
    private static List<FallbackRule> buildRules() {
        List<FallbackRule> list = new ArrayList<>(10);
        ...
        // 第 10 级不参与循环匹配 — 由 classify 方法兜底返回
     ...
     * 兜底启发式分类.
     *
     * @param description 流水摘要, 为空时直接返回 pending
