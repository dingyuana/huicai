...
/**
 * 报表与服务层单元测试 — Mockito 单测 (P8 修复 H2 兼容)
 *
 * <p>覆盖四大报表输出（试算平衡/资产负债表/利润表/现金流量表）及杜邦分析。
 */
...
class ReportServiceTest {
    ...
    @Test
    void subjectBalanceTable_returnsNonEmpty() {
    ...
    @Test
    void balanceSheet_containsAllKeys() {
    ...
    @Test
    void incomeStatement_containsAllKeys() {
    ...
    @Test
    void cashFlowStatement_containsAllKeys() {
    ...
    @Test
    void keyMetrics_containsAllKeys() {
    ...
    @Test
    void dupontAnalysis_containsAllKeys() {
