...
> **更新基准**：commit `9635026` (2026-09-22) — fix(period): use PeriodCloseService for close to enforce previous-period validation, and fix PeriodNavigator revert on invalid period
> **当前分支**：`main`
