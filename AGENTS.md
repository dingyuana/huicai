...
> **更新基准**：commit `5ee3860` (2026-09-17) — feat(batch-5): Prepayment/InvoiceReconcile/AuditLog scope分区+日期必填 对齐BusinessDoc模式
...
|------|------|
| 后端代码 | 461+ Java 文件 |
| 测试用例 | 1817 个 `@Test` 方法 / 210 个测试类（快测 1604 通过，0 Failures, 0 Errors）|
