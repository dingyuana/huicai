...
| REQ-2026-079 | 账簿查询增强 | P1 | 辅助核算账查询（B-011/AT-10）；明细账日期范围；本年累计列；过滤维度；联查穿透 | SPC-060-P60 / SPC-062-P62 / SPC-063-P63 | ✅ T1-T8 全部实现（辅助核算账/日期范围/空提示/余额列/本年累计/过滤/联查/未过账策略），全量 1555 测试 0 失败 |
...
| REQ-2026-015 | 坏账计提 | P1 | 账龄分析、坏账准备计提 | SPC-043-P43 | 📝 SPEC已完成 |
...
| REQ-2026-077 | 企业级建账期间通用化 | P1 | start_period 落库自动回填、默认期间接口、过账校验基于建账期间、前端 11 处默认期间改造 | SPC-P57 | 📝 SPEC 草案待审核 |
| REQ-2026-078 | 期初建账审计增强 | P1 | 期初建账允许任意指定录入时间（建账日期）；记录期初建账日期、录入人员；审计日志修复操作人落库 | SPC-P58 | 📝 SPEC 草案待审核 |
