...
> **版本**：V4.5 | **日期**：2026-09-22 | **维护人**：Hermes
> **说明**：本文档是所有项目文档的权威索引，编号格式 `HUICAI-{分类}-{序号}`
> **编号规则**：MAIN=主文档, DES=设计, ARC=架构, PRD=产品需求, SPC=规格, DEV=开发, TST=测试
> **V4.5 变更**：P87/P88 SPEC 落地（期间锁全链路 + 报表三表信任级缺陷）；翻转 PRD-017 R-139、PRD-018 R-140 状态；数量与实际对齐（prd 21、dsn 18、specs md 93）
...
| HUICAI-PRD-017 | [期末结账工作台-PRD-V1.0.md](./prd/期末结账工作台-PRD-V1.0.md) | DSN-期末结账工作台 | P87 ✅（已建 e893232）/ P84~P86（预留） | ⚠️ P87 已实现，P84~P86 待开发（R-136~138） |
