...
> **关联PRD**：../prd/Agency分支-PRD-V1.0.md, ../prd/基础数据管理-PRD-V1.0.md
...
| 功能 | 所属设计文档 | 优先级 |
|------|-------------|--------|
| 预算编制/控制/调整 | `DSN-预算管理.md` | P1 |
| 杜邦/关键指标/趋势分析 | `DSN-报表分析.md` | P1 |
| 工资薪酬计算/个税/社保 | `DSN-工资薪酬管理.md` | P1 |
| 多客户账套/批量操作/CRM | Agency 分支设计 | P0 (Agency) |
| AI 任务/异常/分类/审核/核销 Agent | `DSN-AI编排层.md` | P2 |
