...
> **关联PRD**：../prd/报表质量与体验增强-PRD-V1.0.md
> **关联SPEC**：P88-report-statement-correctness、P89-report-display-drilldown、P90-report-advanced（均预留）
> **编号**：HUICAI-DES-018
> **版本**：V1.0 | **修改日期**：2026-09-22 | **修改人**：Hermes | **修改内容**：初始创建（三缺陷代码级定位 + 三层增强设计）
...
- **依赖**：P60 辅助核算明细（P90 展开）、P75/P78 余额口径（对比列年初数）
