...
> **状态**：✅ 生效
> **反核销契约更新**：反核销（含制证凭证联动作废）契约以 **S-28-反核销制证凭证联动作废**（HUICAI-SPC-111，2026-09-11）为权威，本 SPEC 中 `/reconciliation/{id}/reverse` 旧描述已被 S-28 的 `/arap-settlements/{id}/reverse` 取代。
