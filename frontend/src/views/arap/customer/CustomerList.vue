<template>
  <div class="customer-list">
    <el-card shadow="never">
      <div class="page-header">
        ...
        <div>
          ...
          <el-button type="primary" @click="showImportDialog = true">导入客户</el-button>
    ...
    <!-- 导入客户对话框 -->
    <el-dialog v-model="showImportDialog" title="导入客户" width="640" destroy-on-close @closed="handleImportClose">
...
import { pageCustomer, createCustomer, updateCustomer, deleteCustomer, importCustomers, downloadCustomerTemplate } from '@/api/modules/arap'
...
async function handleImportFileChange(uploadFile: any) {
  ...
  try {
    ...
    if (res.errors.length === 0) {
      ElMessage.success(`成功导入 ${res.success} 条客户`)
    } else {
