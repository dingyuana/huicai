  ...
  <div class="settlement-panel">
    <div class="toolbar">
      <el-form :model="settlementQuery" inline>
        <el-form-item label="类型">
          <el-select v-model="settlementQuery.settlementType" placeholder="全部" style="width:130px" @change="fetchData">
    ...
    <div class="pagination">
      <el-pagination v-model:current-page="settlementQuery.current" v-model:page-size="settlementQuery.size"
        :total="settlementTotal" layout="total,prev,pager,next" @current-change="fetchData" />
    </div>
...
import ReconciliationTimeline from './ReconciliationTimeline.vue'
